...
namespace rowsSharp.ViewModel
{
    public class FilterVM : ViewModelBase
    {
        ...
        private void Filter()
        {
            ...
            viewModel.Logger.Debug("Filtering CSV, off to BackgroundWorker");

            void Worker_DoWork(object? sender, DoWorkEventArgs e)
            {
                // Prevent spamming by letting ICommand update the IsFiltering property
                ...
                ICollectionView tempRecordsView = CollectionViewSource.GetDefaultView(originalList);
                Application.Current.Dispatcher.Invoke(() => { tempRecordsView.Filter = RecordsViewFilter; });
                
                // Output alias
                if (!viewModel.Config.OutputAlias)
                {
                    e.Result = tempRecordsView;
                    return;
                }
                ...
                e.Result = CollectionViewSource.GetDefaultView(tempRecords);
                return;
            ...
            void Worker_RunWorkerCompleted(object? sender, RunWorkerCompletedEventArgs e)
            {
                ...
                {
                    viewModel.RecordsView = (ICollectionView)e.Result;
                }
